...
contract('MFC_Token', function(accounts) {
    it("should specify totalSupply as 507000000000000000000000000 MFC_Token and put all tokens in the first account", function() {
      ...
      return token.deployed().then(function(instance) {
          ...
          assert.equal(balance_value, 507000000000000000000000000, "507000000000000000000000000 wasn't in the first account");
          assert.equal(totalSupply_value, 507000000000000000000000000, "totalSupply is not 507000000000000000000000000 MFC_Token");
      });
  });
});
